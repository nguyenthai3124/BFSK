...
#
# Script generated by Vivado on Wed Oct 01 10:38:08 +0700 2025
...
#
# Usage        : BFSK.sh
#                BFSK.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BFSK.sh [-reset_run]
#                BFSK.sh [-reset_log]
#                BFSK.sh [-help]
#
...
# script info
echo -e "BFSK.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BFSK.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BFSK.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BFSK.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BFSK.sh [-help]\n\
Usage: BFSK.sh [-step]\n\
Usage: BFSK.sh [-lib_map_path]\n\
Usage: BFSK.sh [-reset_run]\n\
Usage: BFSK.sh [-reset_log]\n\
Usage: BFSK.sh [-keep_index]\n\
Usage: BFSK.sh [-noclean_files]\n\n\
